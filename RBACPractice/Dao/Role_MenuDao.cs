...
using System.Data;
using DBHelper;
public class Role_MenuDao{
public static string InsertSQL(){string lSQL="";
lSQL += "INSERT INTO Role_Menu(";
lSQL += "ID";
lSQL += ",RID";
lSQL += ",MID";
lSQL += ")VALUES(";
...
string lSQL="";
lSQL += "DELETE FROM Role_Menu ";
lSQL += " WHERE ID=@ID";
return lSQL;
}
public static string UpdateSQL(){
string lSQL="";
lSQL += "UPDATE Role_Menu SET ";
lSQL += "ID=@ID";
lSQL += ",RID=@RID";
lSQL += ",MID=@MID";
lSQL += " WHERE ID=@ID";
...
string lSQL="";
lSQL += "EXEC Role_Menu_Page @RID,@MID,@BeginIndex,@EndIndex";
return lSQL;
}
...
public int Insert(Role_MenuModel Role_MenuModel)
{
string lSQL = InsertSQL();
List<SqlParameter> lParams = new List<SqlParameter>();
lParams.Add(new SqlParameter("@ID", Role_MenuModel.ID));
lParams.Add(new SqlParameter("@RID", Role_MenuModel.RID));
lParams.Add(new SqlParameter("@MID", Role_MenuModel.MID));
MsSqlHelper lMSSqlHelper = new MsSqlHelper();
return lMSSqlHelper.ExecuteSQL(lSQL, lParams.ToArray());
}
public int Update(Role_MenuModel Role_MenuModel)
{
